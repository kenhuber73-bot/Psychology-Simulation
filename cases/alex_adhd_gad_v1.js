...
window.CASE_DATA = {
  ...
  questions: [
    ...
    {
      id:'medical', tag:'Medical rule-out',
      text:'Ask if there\'s been a recent physical exam or vision/hearing check',
      note:'"Yeah, my mom took me in earlier this year, actually — she wondered if it was a vision thing since I seemed spacey. Everything checked out fine, vision and hearing both normal, and my doctor didn\'t flag anything else."'
    },
    {
