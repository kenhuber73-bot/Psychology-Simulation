// CASE DATA FILE — Alex M., ADHD vs. Generalized Anxiety Disorder vs. Adjustment Disorder vs. Normal
window.CASE_DATA = {
  ...
  referral: {
    ...
    background: [
      ...
      },
      {
        ...
        text: 'Per Alex\'s medical chart: a vision and hearing screening was completed earlier this year at the parent\'s request, prompted by concern that Alex seemed "spacey." Both screenings were normal, and no other medical concerns are noted in the file.'
      }
    ]
  },
  ...
  collateral: {
    teacher: '"This all really seemed to ramp up right around the time of the divorce, if I\'m remembering correctly — that\'s around when I first started really noticing the disorganization getting bad. Though I\'ll admit I don\'t have my notes from before that in front of me, so I could be misremembering the timeline."',
    parent: '"We actually still have report cards from first and second grade, and the comments are almost word-for-word the same as what teachers say now — \'bright but distracted,\' \'needs reminders to stay on task.\' This has honestly been consistent for years, well before the divorce. We kept the old report cards because we noticed the pattern ourselves a long time ago."'
  },

  disorderReference: [
    {
      name: 'ADHD (Attention-Deficit/Hyperactivity Disorder)',
      summary: 'A developmental pattern of inattention and/or hyperactivity-impulsivity that is more frequent and severe than what\'s typical for the person\'s age, and shows up across multiple settings (not just one class, one subject, or one environment). Several symptoms need to have been present before age 12, since ADHD is understood as a developmental condition rather than something that suddenly appears. Inattentive symptoms include things like difficulty sustaining focus, losing items, and forgetfulness; hyperactive-impulsive symptoms include fidgeting, restlessness, and acting before thinking. Notably, focus difficulty in ADHD is usually about regulating attention, not a total inability to concentrate — many people with ADHD can focus intensely on activities they find highly engaging, which can look confusing from the outside.'
    },
    {
      name: 'Generalized Anxiety Disorder (GAD)',
      summary: 'A pattern of excessive, hard-to-control worry that shows up across several unrelated areas of life, present more days than not for at least six months, paired with physical or cognitive symptoms like restlessness, muscle tension, poor sleep, or trouble concentrating. When anxiety causes attention problems, the distraction is typically driven by intrusive, worried thoughts pulling focus away — which is a meaningfully different mechanism than the attention-regulation difficulty seen in ADHD, even though both can look similar from the outside (a distracted, unfocused student).'
    },
    {
      name: 'Adjustment Disorder',
      summary: 'Emotional or behavioral symptoms that develop in direct response to a specific, identifiable stressor within about three months of it occurring, and are out of proportion to what would normally be expected. The defining feature is a clear, traceable link between the stressor and the onset of symptoms — if the symptoms clearly predate the stressor, or continue unchanged long after it, adjustment disorder becomes a weak fit, since the core idea is that the stressor is what\'s driving the reaction.'
    },
    {
      name: 'Normal Teenage Disorganization (No Diagnosis)',
      summary: 'Not a clinical diagnosis — a reminder that some inattention, forgetfulness, and disorganization is developmentally typical for teenagers, especially as they juggle increasing independence and responsibility. What separates this from a diagnosable condition is scope and impact: is the pattern present across multiple settings and years, not just one class or one rough patch, and is it significantly affecting grades, relationships, or daily functioning?'
    }
  ],
  ...
  checklistCategories: [
    ...
    {
      title: 'Generalized Anxiety — Symptom Checklist',
      labels: {
    ...
    },
    {
      ...
      labels: {
        specific_stressor:'Symptoms tied to, and closely timed with, one identifiable stressor (the divorce)'
      }
    },
    {
      title: 'Normal Teenage Disorganization — Checklist',
      labels: {
        minimal_impact:'Minimal impact on grades or daily functioning',
        brief_duration:'Present only briefly, not since early childhood'
      }
    }
  ],
