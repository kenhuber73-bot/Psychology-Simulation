  ...
  disorderReference: [
    {
      ...
      summary: '<strong>Core Diagnostic Requirements</strong><ul><li><strong>A. Excessive Worry (Criterion A):</strong> Worry that occurs more days than not for at least 6 months, about a number of events or activities (school, relationships, safety of loved ones, etc.) rather than one specific thing.</li><li><strong>B. Uncontrolled Worry (Criterion B):</strong> The person finds it very hard to stop or control the worry.</li><li><strong>C. Associated Symptoms (Criterion C):</strong> Must include 3 or more of the following 6 physical/mental signs (only 1 is needed in children), present more days than not for 6 months:<ul><li>Restlessness or feeling on edge</li><li>Tiring easily or feeling fatigued</li><li>Trouble concentrating or mind going blank</li><li>Irritability</li><li>Muscle tension</li><li>Sleep problems (trouble falling or staying asleep, or restless sleep)</li></ul></li></ul>On top of A–C, the worry and symptoms also need to cause real distress or get in the way of daily functioning, not be better explained by another condition (like panic disorder or PTSD), and not be caused by a substance or a medical condition (like a thyroid problem).'
    },
    {
  ...
  checklistCategories: [
    {
      ...
      cutoff: {
        ...
        note: 'Requires 3+ of these six, with at least some present most days for 6+ months. Worry itself, its spread across domains, duration, and impairment are separate, additional criteria.'
      }
    },
    {
