...
window.CASE_DATA = {
  ...
  disorderReference: [
    ...
    },
    {
      ...
      summary: '<strong>Core Diagnostic Requirements</strong><ul><li><strong>A. Five or More Symptoms:</strong> Five or more of the following nine, present during the same two-week period and representing a change from previous functioning — with at least one being A1 or A2:<ul><li>A1. Depressed mood most of the day, nearly every day (in children/teens, this can look like irritability)</li><li>A2. Loss of interest or pleasure in almost all activities</li><li>A3. Significant appetite or weight change</li><li>A4. Sleep disturbance — too little or too much</li><li>A5. Psychomotor agitation or slowing down, noticeable to others</li><li>A6. Fatigue or low energy</li><li>A7. Feelings of worthlessness or excessive/inappropriate guilt</li><li>A8. Trouble concentrating or making decisions</li><li>A9. Recurrent thoughts of death or suicide</li></ul></li><li><strong>B. Impact:</strong> The symptoms cause real distress or get in the way of daily functioning.</li><li><strong>C. Not Medical:</strong> The symptoms aren\'t caused by a substance or a medical condition (like hypothyroidism).</li><li><strong>D. No Manic History:</strong> There must never have been a manic or hypomanic episode.</li></ul>'
    },
    {
      name: 'Adjustment Disorder',
      summary: '<strong>Core Diagnostic Requirements</strong><ul><li><strong>A. Identifiable Stressor:</strong> Emotional or behavioral symptoms that develop within three months of an identifiable stressor (a move, a breakup, a family change).</li><li><strong>B. Clinical Significance:</strong> The reaction is either out of proportion to how severe the stressor actually is, or noticeably interferes with school, relationships, or other important areas of functioning.</li><li><strong>C. Not Another Disorder:</strong> The reaction can\'t be better explained by another mental disorder, and can\'t simply be a flare-up of a pre-existing one.</li><li><strong>D. Not Bereavement:</strong> The symptoms don\'t represent normal grief after a loss.</li><li><strong>E. Time-Limited:</strong> Once the stressor (or its effects) has ended, symptoms shouldn\'t continue for more than another six months.</li></ul>The core identifying feature is still the clear, traceable link to one triggering event — if symptoms were already present before the stressor, or persist unchanged long after it\'s resolved, adjustment disorder becomes a much weaker fit.'
    },
    {
  ...
  checklistCategories: [
    ...
    },
    {
      ...
      labels: {
        depressed_mood:'A1. Depressed (or, in teens, irritable) mood, most of the day nearly every day',
        anhedonia:'A2. Loss of interest or pleasure in almost all activities',
        appetite_change:'A3. Significant appetite or weight change',
        sleep:'A4. Sleep disturbance — insomnia or hypersomnia',
        psychomotor:'A5. Psychomotor agitation or slowing, observable by others',
        fatigue:'A6. Fatigue or low energy',
        worthlessness_hopelessness:'A7. Worthlessness or excessive, inappropriate guilt',
        concentration:'A8. Impaired concentration or indecisiveness',
        suicidal_ideation:'A9. Recurrent thoughts of death, suicidal ideation, or attempts',
        mdd_duration:'A. (threshold) 5+ of A1–A9, same 2-week period, marking a change from baseline',
        impairment:'B. Causes real distress or gets in the way of daily functioning',
        mdd_not_medical:'C. Not caused by a substance or medical condition',
        mdd_no_mania:'D. Never a manic or hypomanic episode'
      },
      cutoff: {
        count: 5,
        ...
        requireAnyOf: ['depressed_mood','anhedonia'],
        requireAnyOfLabel: 'A1 or A2',
        criterionLabel: 'A',
        note: 'Criterion A requires 5+ of these nine (A1–A9), same 2-week period — with at least one being A1 or A2. B, C, and D are separate, additional criteria.'
      }
    },
    {
      title: 'Adjustment Disorder — Symptom Checklist',
      labels: {
        specific_stressor:'A. Symptoms began within 3 months of an identifiable stressor',
        adj_disproportionate_or_impairing:'B. Distress out of proportion to the stressor, or significant impairment in functioning',
        adj_not_other_disorder:'C. Not better explained by another mental disorder, and not just a flare-up of a pre-existing one',
        adj_not_bereavement:'D. Not simply normal grief after a loss',
        adj_time_limited:'E. Once the stressor ends, symptoms don\'t continue for more than another 6 months'
      }
    },
    {
