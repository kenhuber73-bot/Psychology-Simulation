// CASE DATA FILE — Maya S., Persistent Depressive Disorder (Dysthymia) vs. MDD vs. Bipolar Disorder
window.CASE_DATA = {
  ...
  gadColumnTitle: 'Persistent Depressive Disorder — Symptom Checklist',
  ...
  mddColumnTitle: 'Major Depressive Disorder — Symptom Checklist',

  otherLabels: {
    specific_stressor:'Symptoms triggered by a specific recent stressor (the breakup)',
