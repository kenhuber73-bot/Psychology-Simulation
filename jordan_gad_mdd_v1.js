  ...
  checklistCategories: [
    {
      ...
      cutoff: {
        ...
        note: 'The anxiety and worry need to be associated with three or more of these six symptoms (restlessness, fatigue, concentration, irritability, muscle tension, sleep), with at least some present more days than not for the past 6 months. Excessive worry, its spread across domains, the 6-month duration, and functional impairment are separate requirements — not part of this count.'
      }
    },
    {
      ...
      cutoff: {
        ...
        note: 'Five or more of these nine symptoms need to be present during the same two-week period — and at least one of the five must be depressed mood or loss of interest/pleasure (anhedonia). Meeting the count alone isn\'t enough if neither of those two is checked.'
      }
    },
    {
